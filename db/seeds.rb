...
url = URI("https://yummly2.p.rapidapi.com/feeds/list-similarities?start=19&id=15-Minute-Baked-Salmon-with-Lemon-9029477&limit=18&authorId=Yummly&apiFeedType=moreFrom")
...
recipes["feed"].each do |recipe|
  ...
  recipe["content"]["ingredientLines"].each do |ingredient|
    ...
    r.recipe_ingredients.create(quantity: ingredient["quantity"], ingredient_type: ingredient_type, whole_line: ingredient["wholeLine"], unit: ingredient["unit"], ingredient: ing)
  end
end
